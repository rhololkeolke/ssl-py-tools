...
async def client():
    ...
    print(f"client SetFieldGeometry: reply={reply}")

    reply: GeometryFieldSize = await client.GetFieldGeometry(Empty())
    print(f"client GetFieldGeometry: reply={reply}")
