...
from cmmus_gym.version import VERSION
...
class ProtobufBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        output_dir = setup_path / "cmmus_gym" / "proto"
        ...
        _build_pb_with_prefix(
            "cmmus_gym.proto", setup_path, [str(proto_dir)], proto_files
        )
...
setup(
    ...
    description="Gym environments for training on real robots.",
    ext_modules=[ProtobufExtension("cmmus_gym")],
